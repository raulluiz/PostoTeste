...
{
    class SubConjuntoRepositoryTeste : BaseRepository<SubConjunto>, ISubConjuntoRepository
    {
        protected SubConjuntoRepositoryTeste(PostoContext dbContext) : base(dbContext)
        {
        }
    }
}
